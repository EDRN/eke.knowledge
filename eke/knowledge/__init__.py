...
ProjectMessageFactory = MessageFactory('eke.knowledge')

from eke.knowledge import config
...
def initialize(context):
    ...
    from content import knowledgefolder, knowledgeobject, bodysystem, disease
